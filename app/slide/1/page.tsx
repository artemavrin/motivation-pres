  ...
  return (
    <>
      <div className="flex flex-col h-full w-full items-center justify-center gap-4 page-animation">
        <TextLoop className='text-8xl uppercase font-bold py-10 w-full animate-fade-down' interval={3}>
        ...
        <MotionImage
          initial={{ opacity: 0, top: "50%", left: "50%", rotate: 0, zIndex: 0 }}
          animate={{ opacity: 1, top: "25%", left: "20%", rotate: -12, zIndex: 10 }}
          transition={{ type: "spring", duration: .9, delay: .6 }}
        ...
        <MotionImage
          initial={{ opacity: 0, top: "50%", right: "50%", rotate: 0, zIndex: 0  }}
          animate={{ opacity: 1, top: "20%", right: "20%", rotate: 22, zIndex: 10 }}
          transition={{ type: "spring", duration: .6, delay: .6 }}
        ...
        <MotionImage
          initial={{ opacity: 0, bottom: "50%", right: "50%", rotate: 0, zIndex: 0 }}
          animate={{ opacity: 1, bottom: "25%", right: "12%", rotate: 20, zIndex: 10 }}
          transition={{ type: "spring", duration: .8, delay: .6 }}
        ...
        <MotionImage
          initial={{ opacity: 0, bottom: "50%", left: "50%", rotate: 0, zIndex: 0 }}
          animate={{ opacity: 1, bottom: "20%", left: "15%", rotate: -20, zIndex: 10 }}
          transition={{ type: "spring", duration: .7, delay: .6 }}
